...
function Entry({ params: {entries} } : entryParams) {
    ...
    const blogEntry = blogDB.getCardFromSlug("73pQx/xxxxxxxx")
        ...
        <div className="font-fraunces shadow-2xl max-w-4xl px-2 py-2">
         <div className="flex flex-col md:flex-row">
           <div className="md:flex items-center justify-center md:basis-3/5 order-last md:order-first">
             <ImageWithCredit clickFunction={() => setShowModal(true)} image={blogEntry.image} credit={blogEntry.imageCredit} style="w-142 h-80 object-cover cursor-pointer mx-auto md:mx-0 p-2 transition-transform duration-300 ease-in-out transform hover:scale-105"/>
           </div>
